...
- `type` (String) Custom variable type. must be one of ["order_table", "custom", "journey_link", "snippet"]
...
```terraform
import {
  to = epilot-custom-variable_custom_variable.my_epilot-custom-variable_custom_variable
  id = "rbse777b-3cf8-4bff-bb0c-253fd1123250"
}
```
