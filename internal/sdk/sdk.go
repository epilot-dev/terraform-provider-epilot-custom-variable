...
// Generated from OpenAPI doc version 1.0.0 and generator version 2.634.1
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "1.3.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 1.3.0 2.634.1 1.0.0 github.com/epilot-dev/terraform-provider-epilot-custom-variable/internal/sdk",
