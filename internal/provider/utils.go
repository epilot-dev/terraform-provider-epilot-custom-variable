...
import (
	...
	"errors"
	"fmt"
	tfReflect "github.com/epilot-dev/terraform-provider-epilot-custom-variable/internal/provider/reflect"
...
func fieldHeadersFromRequestReader(reader *textproto.Reader, fields map[string]interface{}) error {
	...
	if _, ok := fields["x-ivy-org-id"]; ok {
		fields["x-ivy-org-id"] = "(sensitive)"
	}
